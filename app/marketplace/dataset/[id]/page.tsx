...
export default function DatasetDetailPage() {
  ...
  // Resolve SuiNS name for the seller
  const { data: sellerSuiNSName } = useSuiNSName(listing?.seller);
    ...
    purchase(
      ...
      (error) => {
        ...
        if (
          ...
          setPurchaseError(
            "Transaction cancelled. You declined the payment request.",
          );
        } else {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2 days ago",
        comment: "Extremely high quality data. Worth every SUI.",
        bgColor: "bg-blue-500",
      },
      {
        id: "r2",
        ...
        rating: 4,
        date: "5 days ago",
        comment: "Solid dataset. Would recommend for DeFi analysis.",
        bgColor: "bg-primary",
      },
    ],
    features: [
            ...
            <div className="relative w-full aspect-2/1 rounded-2xl border-2 border-ink overflow-hidden shadow-hard-lg group">
              ...
              <div className="absolute bottom-4 right-4 flex gap-2">
                ...
                <button
                  ...
                  className="h-10 w-10 bg-white border-2 border-ink rounded-lg flex items-center justify-center hover:bg-accent-lime transition-colors shadow-hard-sm text-ink disabled:opacity-50"
                >
                  <span
                    className={`material-symbols-outlined ${isDownloading ? "animate-spin" : ""}`}
                  >
              ...
              <div className="flex flex-col gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                ...
                {isPurchased && displayTxDigest && (
                  <div className="flex items-center gap-2 flex-wrap pt-2 border-t border-gray-200 mt-1">
                    ...
                    <code className="text-xs font-mono text-ink bg-green-50 px-2 py-1 rounded border border-green-200">
                      {displayTxDigest.slice(0, 16)}...
                      {displayTxDigest.slice(-8)}
                    </code>
                    <a
                      href={`https://suiscan.xyz/testnet/tx/${displayTxDigest}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="h-6 w-6 rounded bg-green-100 hover:bg-green-200 flex items-center justify-center border border-green-300"
