          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              ...
              {listings && listings.map(listing => (
                <article
                  key={listing.id}
                  onClick={() => router.push(`/marketplace/dataset/${listing.id}`)}
                ...
                >
                  ...
                  {/* Content */}
                  <div className="p-4 flex flex-col flex-1">
                    <h3 className="text-base font-bold text-ink mb-1 line-clamp-2 group-hover:text-primary transition-colors">{listing.name}</h3>
                    ...
                    {/* Actions */}
                    <div className="flex gap-2 mt-auto pt-3 border-t border-gray-200" onClick={(e) => e.stopPropagation()}>
                      <a
                        href={`https://walruscan.com/testnet/blob/${listing.blobId}`}
                        target="_blank"
                        rel="noopener noreferrer"
                      ...
                      <button
                        className="flex-1 h-9 rounded-lg border-2 border-ink bg-gray-100 text-ink text-sm font-bold hover:bg-gray-200 transition-colors flex items-center justify-center gap-1"
                        onClick={(e) => e.stopPropagation()}
                      >
